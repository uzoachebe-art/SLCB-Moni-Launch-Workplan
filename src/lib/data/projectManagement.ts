      ...
      },
      {
        ...
        items: [
          ...
          { id: "p0-agent-4", text: "Set a minimum monthly enrolment threshold for an agent to remain active", aaarrr: ["acquisition", "activation"] },
          {
            ...
            flags: [{ type: "conflict", note: "The source's own KPI Framework notes that three internal SLCB documents give differing overall agent-count targets. Not resolved here and no figures shown, consistent with this tab's standing rule; reconcile before communicating any external commitment on agent numbers." }],
          },
        ],
      },
      {
